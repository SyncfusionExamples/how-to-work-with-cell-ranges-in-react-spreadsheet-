...
function App() {
    ...
    const onBtnClick=()=>{
        ...
        // ssObj.merge("B1:D1", "All") //To merge the cell
       ...
       <SheetsDirective>
          <SheetDirective name="Price Details">
            <RowsDirective>
                <RowDirective>
                    <CellsDirective>
                        <CellDirective rowSpan={2} value='Item Name'></CellDirective>
                        <CellDirective index={1} colSpan={3} value="Price Detials"></CellDirective>
                    </CellsDirective>
                </RowDirective>
                <RowDirective>
                    <CellsDirective>
